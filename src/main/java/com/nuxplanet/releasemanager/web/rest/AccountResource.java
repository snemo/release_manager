...
import com.nuxplanet.releasemanager.domain.PersistentToken;
import com.nuxplanet.releasemanager.domain.User;
import com.nuxplanet.releasemanager.repository.PersistentTokenRepository;
import com.nuxplanet.releasemanager.repository.UserRepository;
import com.nuxplanet.releasemanager.security.SecurityUtils;
import com.nuxplanet.releasemanager.service.MailService;
import com.nuxplanet.releasemanager.service.ProjectService;
import com.nuxplanet.releasemanager.service.UserService;
import com.nuxplanet.releasemanager.service.dto.UserDTO;
import com.nuxplanet.releasemanager.web.rest.vm.KeyAndPasswordVM;
import com.nuxplanet.releasemanager.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public ResponseEntity<UserDTO> getAccount() {
        return Optional.ofNullable(userService.getUserWithAuthorities())
            .map(user -> new ResponseEntity<>(new UserDTO(user, projectService.getUserProjects(user)), HttpStatus.OK))
            .orElse(new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR));
    }
